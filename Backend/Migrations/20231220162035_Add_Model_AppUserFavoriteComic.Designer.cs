...
namespace Webcomic.Migrations
{
    ...
    [Migration("20231220162035_Add_Model_AppUserFavoriteComic")]
    partial class Add_Model_AppUserFavoriteComic
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Webcomic.Models.Entities.ComicTag", b =>
                {
                    b.Property<int>("ComicId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ComicTag", (string)null);
                });

            modelBuilder.Entity("Webcomic.Models.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Webcomic.Models.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Webcomic.Models.Entities.ComicTag", b =>
                {
                    ...
                    b.HasOne("Webcomic.Models.Entities.Tag", "Tag")
                        .WithMany("ComicTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
